...
public class CourseRetrieverService {
    //author name in PL link was replaced with "%s", this is also calling the API
    ...
    public List<PluralsightCourse> getCoursesFor(String authorId){
        ...
        try {
            ...
            //the switch handles rare exception and outputs a value (almost like the when statement)
